# Shared Browser Session + Providers

Canonical provider wiring for 1AM wallet browser dApps. Copy into `lib/midnight.ts`.

See also [gotchas.md](gotchas.md) and [versions.json](versions.json).
